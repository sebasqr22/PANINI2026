...
export const COCA_STICKERS: Sticker[] = [
  ...
  { id: 'CC04', name: 'Santiago Gimenez (Mexico)', section: 'coca', type: 'special', albumOrder: 4 },
  { id: 'CC05', name: 'Josko Gvardiol (Croacia)', section: 'coca', type: 'special', albumOrder: 5 },
  { id: 'CC06', name: 'Federico Valverde (Uruguay)', section: 'coca', type: 'special', albumOrder: 6 },
  { id: 'CC07', name: 'Jefferson Lerma (Colombia)', section: 'coca', type: 'special', albumOrder: 7 },
  { id: 'CC08', name: 'Enner Valencia (Ecuador)', section: 'coca', type: 'special', albumOrder: 8 },
  { id: 'CC09', name: 'Gabriel Magalhaes (Brasil)', section: 'coca', type: 'special', albumOrder: 9 },
  { id: 'CC10', name: 'Virgil Van Dijk (Paises Bajos)', section: 'coca', type: 'special', albumOrder: 10 },
  { id: 'CC11', name: 'Alphonso Davied (Canada)', section: 'coca', type: 'special', albumOrder: 11 },
  { id: 'CC12', name: 'Emiliano Martinez (Argentina)', section: 'coca', type: 'special', albumOrder: 12 },
  { id: 'CC13', name: 'Raul Jimenez (Mexico)', section: 'coca', type: 'special', albumOrder: 13 },
  { id: 'CC14', name: 'Lautaro Martinez (Argentina)', section: 'coca', type: 'special', albumOrder: 14 },
];
